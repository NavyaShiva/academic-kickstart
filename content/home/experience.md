...
[[experience]]
 ...
 [[experience]]
  ...
  company = "Mialo Technologies"
  company_url = ""
  location = "Bangalore, India"
  date_start = "2018-02-01"
  date_end = "2018-05-01"
  description = """
  Implemented a Computer vision algorithm to ‘Automate License Plate Recognition’, using OpenCV and Numpy libraries on Python in the Linux platform, predicted with an accuracy
  of 71% that enabled the business to automate the parking system.
  
  Tools and Methods - OpenCV
  """
  
 [[experience]]
  title = "Graduate Engineer Trainee"
  company = "Praj Industrues Limited"
  company_url = ""
  location = "Pune, India"
  date_start = "2015-07-01"
  date_end = "2017-07-01"
  description = """
  Predicted the design parameters using Multivariate Regression Analysis with an accuracy of 93%, resulted in cost reduction of $106K.
  Tools:  R, Matlab
  """
+++
